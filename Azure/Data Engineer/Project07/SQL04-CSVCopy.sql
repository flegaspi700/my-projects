...
CREATE LOGIN user_load WITH PASSWORD = '<password>';
...
-- Change storage account access level to Blob for public access
COPY INTO logdata FROM 'https://<externalstorage>.blob.core.windows.net/<container/path>'
WITH
(
FIRSTROW=2
)
